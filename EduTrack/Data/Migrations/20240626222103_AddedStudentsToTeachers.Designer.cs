...
namespace EduTrack.Data.Migrations
{
    ...
    [Migration("20240626222103_AddedStudentsToTeachers")]
    partial class AddedStudentsToTeachers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EduTrack.Models.Mark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StudentSubject", b =>
                {
                    b.HasOne("EduTrack.Models.Student", null)
                        .WithMany()
                        .HasForeignKey("StudentsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EduTrack.Models.Subject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("StudentTeacher", b =>
                {
                    ...
                    b.HasOne("EduTrack.Models.Teacher", null)
                        .WithMany()
